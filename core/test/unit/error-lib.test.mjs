...
// and `lib/extras/error/observe.qlang` verbs. These files are
...
// verbs into env before invoking them; the code a verb runs is handed
// to it as a quote.
//
// Each verb is exercised against both of the branches that its
