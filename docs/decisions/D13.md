...
Replaced in part by [D87], under which the places declared for any value
are the elements of a container, and an argument of a step hands an
error on whatever the kind of its slot.
