...
Replaced in part by [D88], under which a tag name in the subject
position is dispatched to the noun it names, after the verbs of tag
names, and each step resolves by its own subject.
