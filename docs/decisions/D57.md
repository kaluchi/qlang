...
Replaced in part by [D60], under which the doc of a slot leaves the head
for the kind of the slot.
Replaced in part by [D64], under which the result's kind stands after the
tilde and the brackets hold what the verb takes.
